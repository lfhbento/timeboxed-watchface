...
class Swatches extends Component {
  constructor(props) {
    ...
    this.sunlightColors = this.colors.map(list =>
      list.map(item => this.sunlightColorMap[item])
    );
...
class SwatchItem extends Component {
  ...
  render() {
    ...
    return (
      <div
        className="color-panel--swatch-item"
